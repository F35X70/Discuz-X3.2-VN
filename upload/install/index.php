...
if($method == 'show_license') {
	...
	if(!file_exists(ROOT_PATH.$default_configfile)) {
		exit('config_global_default.php was lost, please re upload this file.');
	} else {
	...
	$adminemail = 'kyehani@discuzvn.com';
	...
	if(VIEW_OFF) {
		...
		show_header();
		echo '</div><div class="main" style="margin-top: -123px;padding-left:30px"><a href="'.$default_appurl.'">'.$lang['install_finish'].'</a></div>';
		show_footer();
	}
