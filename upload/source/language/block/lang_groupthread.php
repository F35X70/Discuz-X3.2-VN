...
(
	...
	'groupthread_keyword_comment' => 'Thiết lập các từ khóa được sử dụng.<br />Bạn có thể sử dụng ký tự đại diện "*" trong từ khóa.<br />Nếu bạn muốn sử dụng nhiều từ khóa cùng lúc, bạn có thể sử dụng "AND". Ví dụ: win32 AND Unix.<br />Nếu bạn  chỉ muốn sử dụng một từ khóa, bạn có thể dùng "|" hoặc "OR". Ví dụ: win32 OR unix',
