...
<p class="mbn"><a href="home.php?mod=magic" target="_blank">Quay lại Shop</a><span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">Xem nhà kho</a></p>',
	...
	'thread_hidden' => 'Chủ đề của bạn <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>đã bị nhiều người báo cáo là spam &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
