...
(
	...
	'get_passwd_message'	=> '
<p>{username},
Lá thư này được gửi từ diễn đàn {bbname}.</p>
...
<p>
----------------------------------------------------------------------<br />
<strong>Xin hãy đọc nó thật kỹ nhé.</strong><br />
----------------------------------------------------------------------</p>
...
$_G[siteurl]',
	...
	'email_to_invite_subject'	=> 'Bạn của bạn: {$_G[member][username]} gửi một mã mời tham gia {$_G[setting][bbname]} đến bạn',//'æ‚¨çš„æœ‹å‹ {$_G[member][username]} å‘é€ {$_G[setting][bbname]} è®ºå›æ³¨å†Œé‚€è¯·ç ç»™æ‚¨',
