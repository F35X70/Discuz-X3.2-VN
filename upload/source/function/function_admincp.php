...
function rewritedata($alldata = 1) {
	...
	if(!$alldata) {
		...
		$data['rulesearch']['forum_forumdisplay'] = 'forum-{forum}-{fid}-{page}.html';
		$data['rulereplace']['forum_forumdisplay'] = 'forum.php?mod=forumdisplay&fid={fid}&page={page}&%{forum}';
		$data['rulevars']['forum_forumdisplay']['{fid}'] = '(\w+)';
		$data['rulevars']['forum_forumdisplay']['{page}'] = '([0-9]+)';
        $data['rulevars']['forum_forumdisplay']['{forum}'] = '(.*)';

		$data['rulesearch']['forum_viewthread'] = 'thread-{thread}-{tid}-{page}-{prevpage}.html';
