...
showtablerow('', array('class="vtop td24 lineheight"'), array(
	...
	'<span class="bold"><a href="http://www.comsenz.com" class="lightlink2" target="_blank">Comsenz</a></span>'
));
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont team"'), array(
	cplang('home_dev_manager'),
	'<a href="http://www.discuz.net/home.php?mod=space&uid=1" class="lightlink2 smallfont" target="_blank">Kevin \'Crossday\' Day</a>'
));
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight smallfont team"'), array(
...
showtablerow('', array('class="vtop td24 lineheight"', 'class="lineheight"'), array(
	...
	'<a href="http://www.discuzvn.com" class="lightlink2" target="_blank">Discuz VN</a>'
));
showtablefooter();
