	...
	for(var i = 0; i < buttons.length; i++) {
		if(buttons[i].id.indexOf(editorid + '_') != -1) {
			...
			if(buttons[i].id.substr(buttons[i].id.indexOf('_') + 1) == 'fullswitcher') {
				buttons[i].innerHTML = !editorisfull ? 'Toàn màn hình' : 'Thu nhỏ';
				buttons[i].onmouseover = function(e) {setEditorTip(editorisfull ? 'Thu nhỏ' : 'Toàn màn hình');};
...
function editorfull(op) {
	...
	$(editorid + '_fullswitcher').innerHTML = editorisfull ? 'Thu nhỏ' : 'Toàn màn hình';
	initesbar();
}
	...
	if(menu) {
		...
		switch(tag) {
			...
			case 'postbg':
				...
				break;
			case 'password':
				str = '<p class="pbn">Hãy nhập mật khẩu bài viết: <input type="text" id="' + ctrlid + '_param_1" size="10" value="" class="px" /></p>';
				break;
			case 'code':
				if(wysiwyg) {
			...
			case 'tbl':
				...
				str += '<div id="tbltips_msg" style="display: none">“[tr=Màu]” Viền<br />“[td=Chiều rộng]” Xác định chiều rộng cột<br />“[td=Cột,Hàng,Rộng]” Rộng<br /><br />Ví dụ viết nhanh<div class=\'xs0\' style=\'margin:0 5px\'>[table]<br />Name:|Discuz!<br />Version:|X3<br />[/table]</div>Với"|"Tách mỗi cột, bảng nếu"|"Với"\\|"Thay vào đó, sử dụng dòng"\\n"Thay vào đó.</div>';
				break;
			case 'aud':
			...
			case 'fls':
				...
				break;
			case 'beginning':
				str = '<p class="pbn">Enter the beginning of the Flash or image address:</p><p class="pbn"><input type="text" id="' + ctrlid + '_param_1" class="px" value="" style="width: 220px;" /></p>';
				str += '<p class="pbn">Nhập vào URL:</p><p class="pbn"><input type="text" id="' + ctrlid + '_param_2" class="px" value="" style="width: 220px;" /></p>';
				str += '<p class="pbn">Rộng: <input id="' + ctrlid + '_param_3" size="5" value="" class="px" /> &nbsp; Cao: <input id="' + ctrlid + '_param_4" size="5" value="" class="px" /></p>';
				str += '<p class="pbn">Phát từ giây: <input id="' + ctrlid + '_param_8" size="5" value="" class="px" /></p>';
				str += '<p class="pbn">Hiệu ứng: </p><p class="pbn"><input id="' + ctrlid + '_param_7" type="radio" name="effect" checked />Không &nbsp; <input id="' + ctrlid + '_param_5" type="radio" name="effect" />Fade in fade out &nbsp; <input id="' + ctrlid + '_param_6" type="radio" name="effect" />Closed</p>';
			...
			case 'index':
				...
				str = '<p class="pbn">[index]<br />\n\
					[#<span class="xi1">Số trang</span>]<span class="xi1">Tiêu đề</span> &nbsp;&nbsp;<span class="xg1">Nhảy đến trang chỉ định</span><br />\n\
					<span class="xi1">*</span>[#<span class="xi1">tid,pid</span>]<span class="xi1">Tiêu đề</span> &nbsp;&nbsp;<span class="xg1">Nhảy đến bài chỉ định</span><br />\n\
					[/index]<br />\n\
					<br />\n\
					<span class="xi1">Số trang</span> &nbsp;&nbsp;<span class="xg1">[page] on the current post page after page number</span><br />\n\
					<span class="xi1">tid,pid</span> &nbsp;&nbsp;<span class="xg1">Posts in TID and PID</span><br />\n\
					<span class="xi1">*</span> &nbsp;&nbsp;<span class="xg1">Thêm đẩy dòng</span></p>';
				break;
			default:
